...
def about_author():
    while True:
        ...
        print("========================================")
        pas = input("Введите пароль (или 0 чтобы уйти): ")
        if pas == "0":
            break
        if pas == "Novosibirsk2026":
            print("\n========================================")
            print("Вы нашли пароль через код? Классно! 😎")
            print("========================================")
            print()
            time.sleep(1)
            ...
            print()
            print("Меня зовут Смирнов Никита. Символично получилось с библиотекой, да?")
            time.sleep(1)
            print("Я на самом деле очень люблю читать. Так что сделать проект про книги")
            time.sleep(1)
            print("было для меня скорее удовольствием, чем просто задачей.")
            time.sleep(1)

            print()
            print("Обожаю истории, которые переворачивают сознание с ног на голову!")
            time.sleep(1)
            print("Моя любимая книга — «Пикник на обочине»: у неё своя, ни на что не похожая атмосфера.")
            time.sleep(1)

            print()
            print("На самом деле я программирую лет с 12-13. Хотя иногда и не скажешь :)")
            time.sleep(1)
            print("Самые мои большие проекты:")
            time.sleep(1)
            print("- Пиксель-арт игра про Французскую революцию (писал на GML).")
            time.sleep(1)
            print("- Остальное — всякие мелкие программки, вроде этой.")
            time.sleep(1)

            print()
            print("Сейчас изучаю Go, а Python знаю примерно на таком уровне, как в этой работе.")
            time.sleep(1)

            print()
            print("Всё, не отвлекаю. Можете дальше смотреть проект 😊")
            time.sleep(1)
            print("========================================")
            input("0 - Назад")
            break
